    ...
    if home_attack_dir == 'Left to Right':
        ...
        for num in range(11,21):
            ...
            synced_events.loc[:second_half_idx,f'player_{num}_dist_to_goal'],\
                synced_events.loc[:second_half_idx,f'player_{num}_angle_to_goal']=calc_angle_and_distance_to_goal(a_p_X_fh,a_p_Y_fh,True)
            synced_events.loc[second_half_idx:,f'player_{num}_dist_to_goal'],\
                    synced_events.loc[second_half_idx:,f'player_{num}_angle_to_goal']=calc_angle_and_distance_to_goal(a_p_X_sh,a_p_Y_sh,False)
        # away goalkeeper
        ...
        synced_events.loc[:second_half_idx,'player_22_dist_to_goal'],\
                synced_events.loc[:second_half_idx,'player_22_angle_to_goal']=calc_angle_and_distance_to_goal(a_gk_X_fh,a_gk_Y_fh,True)
        synced_events.loc[second_half_idx:,'player_22_dist_to_goal'],\
                synced_events.loc[second_half_idx:,'player_22_angle_to_goal']=calc_angle_and_distance_to_goal(a_gk_X_sh,a_gk_Y_sh,False)
        # home players
        for num in range(1,11):
            ...
            synced_events.loc[:second_half_idx,f'player_{num}_dist_to_goal'],\
                synced_events.loc[:second_half_idx,f'player_{num}_angle_to_goal']=calc_angle_and_distance_to_goal(h_p_X_fh,h_p_Y_fh,False)
            synced_events.loc[second_half_idx:,f'player_{num}_dist_to_goal'],\
                synced_events.loc[second_half_idx:,f'player_{num}_angle_to_goal']=calc_angle_and_distance_to_goal(h_p_X_sh,h_p_Y_sh,True)
        #hom
        ...
        synced_events.loc[:second_half_idx,'player_21_dist_to_goal'],\
                synced_events.loc[:second_half_idx,'player_21_angle_to_goal']=calc_angle_and_distance_to_goal(h_gk_X_fh,h_gk_Y_fh,False)
        synced_events.loc[second_half_idx:,'player_21_dist_to_goal'],\
                synced_events.loc[second_half_idx:,'player_21_angle_to_goal']=calc_angle_and_distance_to_goal(h_gk_X_sh,h_gk_Y_sh,True)
        ...
        if event['event_team'] == 0:
            synced_events.loc[:second_half_idx,'ball_dist_to_goal'],\
                synced_events.loc[:second_half_idx,'ball_angle_to_goal']=calc_angle_and_distance_to_goal(b_X_fh,b_Y_fh,False)
            synced_events.loc[second_half_idx:,'ball_dist_to_goal'],\
            ...
            synced_events.loc[:second_half_idx,'ball_dist_to_goal'],\
                synced_events.loc[:second_half_idx,'ball_angle_to_goal']=calc_angle_and_distance_to_goal(b_X_fh,b_Y_fh,True)
            synced_events.loc[second_half_idx:,'ball_dist_to_goal'],\
                synced_events.loc[second_half_idx:,'ball_angle_to_goal']=calc_angle_and_distance_to_goal(b_X_sh,b_Y_sh,False)
        ...
        for num in range(11,21):
            ...
            synced_events.loc[:second_half_idx,f'player_{num}_dist_to_goal'],\
                synced_events.loc[:second_half_idx,f'player_{num}_angle_to_goal']=calc_angle_and_distance_to_goal(a_p_X_fh,a_p_Y_fh,False)
            synced_events.loc[second_half_idx:,f'player_{num}_dist_to_goal'],\
                    synced_events.loc[second_half_idx:,f'player_{num}_angle_to_goal']=calc_angle_and_distance_to_goal(a_p_X_sh,a_p_Y_sh,True)
        # away goalkeeper
        a_gk_X_fh = synced_events.loc[:second_half_idx,'player_22_x']
        a_gk_Y_fh = synced_events.loc[:second_half_idx,'player_22_y']
        a_gk_X_sh = synced_events.loc[second_half_idx:,'player_22_x']
        a_gk_Y_sh = synced_events.loc[second_half_idx:,'player_22_y']
        synced_events.loc[:second_half_idx,'player_22_dist_to_goal'],\
                synced_events.loc[:second_half_idx,'player_22_angle_to_goal']=calc_angle_and_distance_to_goal(a_gk_X_fh,a_gk_Y_fh,False)
        synced_events.loc[second_half_idx:,'player_22_dist_to_goal'],\
                synced_events.loc[second_half_idx:,'player_22_angle_to_goal']=calc_angle_and_distance_to_goal(a_gk_X_sh,a_gk_Y_sh,True)
        # home players
        for num in range(1,11):
            h_p_X_fh = synced_events.loc[:second_half_idx,f'player_{num}_x']
            h_p_Y_fh = synced_events.loc[:second_half_idx,f'player_{num}_y']
            ...
            synced_events.loc[:second_half_idx,f'player_{num}_dist_to_goal'],\
                synced_events.loc[:second_half_idx,f'player_{num}_angle_to_goal']=calc_angle_and_distance_to_goal(h_p_X_fh,h_p_Y_fh,True)
            synced_events.loc[second_half_idx:,f'player_{num}_dist_to_goal'],\
                synced_events.loc[second_half_idx:,f'player_{num}_angle_to_goal']=calc_angle_and_distance_to_goal(h_p_X_sh,h_p_Y_sh,False)
        #home goalkeeper - calc_angle_and_distance_to_goal(home player X, home player Y, True)
        h_gk_X_fh = synced_events.loc[:second_half_idx,'player_21_x']
        h_gk_Y_fh = synced_events.loc[:second_half_idx,'player_21_y']
        h_gk_X_sh = synced_events.loc[second_half_idx:,'player_21_x']
        h_gk_Y_sh = synced_events.loc[second_half_idx:,'player_21_y']
        synced_events.loc[:second_half_idx,'player_21_dist_to_goal'],\
                synced_events.loc[:second_half_idx,'player_21_angle_to_goal']=calc_angle_and_distance_to_goal(h_gk_X_fh,h_gk_Y_fh,True)
        synced_events.loc[second_half_idx:,'player_21_dist_to_goal'],\
                synced_events.loc[second_half_idx:,'player_21_angle_to_goal']=calc_angle_and_distance_to_goal(h_gk_X_sh,h_gk_Y_sh,False)
...
def create_dataset(path,metadata_fn,init_match_i, final_match_i, ds_fn):
    data = []
    ...
    for i in range(init_match_i,final_match_i):
        ...
        tracking,event = flatten_and_features(path,match_id,metadata_fn)
...
match_ovw = pd.read_csv(path+'2021-10-21-stats-perform-data-availability (3).csv')
match_ovw = match_ovw.drop(columns=[
    'competition_id','tournament_id','match_date','match_time','match_description',
    'match_week','match_status','ma1','ma2','ma3','tracking-10fps'])
available_matches = get_available_matches(path) #match_ovw[(match_ovw['ma13']==True) & (match_ovw['tracking-25fps']==True)]['match_id'].tolist()
